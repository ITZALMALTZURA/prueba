        ...
        <div class="col">
            <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <a href="<?php echo base_url('newuser'); ?>" class="w-100 btn btn-lg btn-outline-primary">Agregar Usuarios</a>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <a href="<?php echo base_url('users'); ?>" class="w-100 btn btn-lg btn-outline-primary">Ver Reportes</a>
                </div>
            </div>
        </div>
    </div>
